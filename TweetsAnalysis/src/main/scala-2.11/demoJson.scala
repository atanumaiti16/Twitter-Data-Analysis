...
object demoJson {
  def main(args: Array[String]): Unit ={
    ...
    //RDD-1 :
    val tweettable =  sqlContext.read.json ("/home/monica/Documents/PBPhase2/CleanElections.json")
    ...
    ).saveAsTextFile("/home/monica/Documents/PBPhase2/RDD1/RDD1a_MentionHillary")
    ...
    mentionTrump.map(row =>
      row.getLong(0)+","+row.getLong(1)
    ).saveAsTextFile("/home/monica/Documents/PBPhase2/RDD1/RDD1a_MentionTrump")
    println(mentionTrump.count()) //output: 35075
    // collect().fo.write.format("com.databricks.spark.csv").save("/home/monica/Documents/PBPhase2/RDD1"
...
//
//   // val trendingHash = sqlContext.read.parquet("/home/monica/Documents/PBPhase2/trendinghashtags.parquet")
...
//
//
//    val writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("/home/monica/Documents/PBPhase2/DF1/trendinghashtags.txt",true)))
//    for (x<- listHash) {
//      writer.write(x + "\n")
//    }
//    writer.close()
...
//    locTweets.saveAsTextFile("/home/monica/Documents/PBPhase2/RDD2_Locations")
//
//
...
//    media_url2.show()
//    media_url.write.save("/home/monica/Documents/PBPhase2/DF2/mediaUrl")
//    media_url2.write.save("/home/monica/Documents/PBPhase2/DF2/trendingMediaUrl")
